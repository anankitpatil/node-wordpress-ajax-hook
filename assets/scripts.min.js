...
r,c=$a[a];return c||(c=Za(a,b),"none"!==c&&c||(T=(T||d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement),b=T[0].contentDocument,b.write(),b.close(),c=Za(a,b),T.detach()),$a[a]=c),c}function Z(a,b,c){var e,f,g,h,k=a.style;return c=c||ra(a),c&&(h=c.getPropertyValue(b)||c[b]),c&&(""!==h||d.contains(a.ownerDocument,a)||(h=d.style(a,b)),Ga.test(h)&&ab.test(b)&&(e=k.width,f=k.minWidth,g=k.maxWidth,k.minWidth=k.maxWidth=k.width=h,h=c.width,k.width=e,k.minWidth=f,k.maxWidth=g)),
...
"padding"+H[b],!0,f)),"margin"!==c&&(g-=d.css(a,"border"+H[b]+"Width",!0,f))):(g+=d.css(a,"padding"+H[b],!0,f),"padding"!==c&&(g+=d.css(a,"border"+H[b]+"Width",!0,f)));return g}function gb(a,b,c){var e=!0,f="width"===b?a.offsetWidth:a.offsetHeight,g=ra(a),h="border-box"===d.css(a,"boxSizing",!1,g);if(0>=f||null==f){if(f=Z(a,b,g),(0>f||null==f)&&(f=a.style[b]),Ga.test(f))return f;e=h&&(x.boxSizingReliable()||f===a.style[b]);f=parseFloat(f)||0}return f+fb(a,b,c||(h?"border":"content"),e,g)+"px"}function hb(a,
b){for(var c,e,f,g=[],h=0,k=a.length;k>h;h++)e=a[h],e.style&&(g[h]=t.get(e,"olddisplay"),c=e.style.display,b?(g[h]||"none"!==c||(e.style.display=""),""===e.style.display&&U(e)&&(g[h]=t.access(e,"olddisplay",Fa(e.nodeName)))):(f=U(e),"none"===c&&f||t.set(e,"olddisplay",f?c:d.css(e,"display"))));for(h=0;k>h;h++)e=a[h],e.style&&(b&&"none"!==e.style.display&&""!==e.style.display||(e.style.display=b?g[h]||"":"none"));return a}function z(a,b,c,d,f){return new z.prototype.init(a,b,c,d,f)}function ib(){return setTimeout(function(){aa=
void 0}),aa=d.now()}function sa(a,b){var c,d=0,f={height:a};for(b=b?1:0;4>d;d+=2-b)c=H[d],f["margin"+c]=f["padding"+c]=a;return b&&(f.opacity=f.width=a),f}function jb(a,b,c){for(var d,f=(P[b]||[]).concat(P["*"]),g=0,h=f.length;h>g;g++)if(d=f[g].call(c,b,a))return d}function Rb(a,b){var c,e,f,g,h;for(c in a)if(e=d.camelCase(c),f=b[e],g=a[c],d.isArray(g)&&(f=g[1],g=a[c]=g[0]),c!==e&&(a[e]=g,delete a[c]),h=d.cssHooks[e],h&&"expand"in h)for(c in g=h.expand(g),delete a[e],g)c in a||(a[c]=g[c],b[c]=f);
else b[e]=f}function kb(a,b,c){var e,f=0,g=ta.length,h=d.Deferred().always(function(){delete k.elem}),k=function(){if(e)return!1;for(var b=aa||ib(),b=Math.max(0,l.startTime+l.duration-b),c=1-(b/l.duration||0),d=0,f=l.tweens.length;f>d;d++)l.tweens[d].run(c);return h.notifyWith(a,[l,c,b]),1>c&&f?b:(h.resolveWith(a,[l]),!1)},l=h.promise({elem:a,props:d.extend({},b),opts:d.extend(!0,{specialEasing:{}},c),originalProperties:b,originalOptions:c,startTime:aa||ib(),duration:c.duration,tweens:[],createTween:function(b,
...
!g["*"]&&f("*")}function Ia(a,b){var c,e,f=d.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((f[c]?a:e||(e={}))[c]=b[c]);return e&&d.extend(!0,a,e),a}function Ja(a,b,c,e){var f;if(d.isArray(b))d.each(b,function(b,d){c||Sb.test(a)?e(a,d):Ja(a+"["+("object"==typeof d?b:"")+"]",d,c,e)});else if(c||"object"!==d.type(b))e(a,b);else for(f in b)Ja(a+"["+f+"]",b[f],c,e)}var V=[],Q=V.slice,nb=V.concat,Ka=V.push,oa=V.indexOf,ba={},Tb=ba.toString,La=ba.hasOwnProperty,x={},r=v.document,d=function(a,b){return new d.fn.init(a,
b)},Ub=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Vb=/^-ms-/,Wb=/-([\da-z])/gi,Xb=function(a,b){return b.toUpperCase()};d.fn=d.prototype={jquery:"2.1.1",constructor:d,selector:"",length:0,toArray:function(){return Q.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:Q.call(this)},pushStack:function(a){a=d.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return d.each(this,a,b)},map:function(a){return this.pushStack(d.map(this,function(b,
c){return a.call(b,c,b)}))},slice:function(){return this.pushStack(Q.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:Ka,sort:V.sort,splice:V.splice};d.extend=d.fn.extend=function(){var a,b,c,e,f,g,h=arguments[0]||{},k=1,l=arguments.length,p=!1;"boolean"==typeof h&&(p=h,h=arguments[k]||{},k++);
...
return a},trim:function(a){return null==a?"":(a+"").replace(Ub,"")},makeArray:function(a,b){var c=b||[];return null!=a&&(Ca(Object(a))?d.merge(c,"string"==typeof a?[a]:a):Ka.call(c,a)),c},inArray:function(a,b,c){return null==b?-1:oa.call(b,a,c)},merge:function(a,b){for(var c=+b.length,d=0,f=a.length;c>d;d++)a[f++]=b[d];return a.length=f,a},grep:function(a,b,c){for(var d=[],f=0,g=a.length,h=!c;g>f;f++)c=!b(a[f],f),c!==h&&d.push(a[f]);return d},map:function(a,b,c){var d,f=0,g=a.length,h=[];if(Ca(a))for(;g>
...
y)}f&&((m=!p&&m)&&s--,d&&u.push(m))}if(s+=W,f&&W!==s){for(n=0;p=c[n++];)p(u,t,e,h);if(d){if(0<s)for(;W--;)u[W]||t[W]||(t[W]=Y.call(k));t=v(t)}da.apply(k,t);l&&!d&&0<t.length&&1<s+c.length&&b.uniqueSort(k)}return l&&(E=y,J=r),u};return f?d(h):h}var L,w,q,B,ka,wa,Oa,z,J,ea,ua,ca,C,R,F,D,la,I,G,y="sizzle"+-new Date,K=a.document,E=0,Q=0,pb=c(),N=c(),O=c(),M=function(a,b){return a===b&&(ua=!0),0},H="undefined",S=-2147483648,ia={}.hasOwnProperty,fa=[],Y=fa.pop,aa=fa.push,da=fa.push,V=fa.slice,ja=fa.indexOf||
...
"g"),ma=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,na=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,oa=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),pa=RegExp(U),qa=RegExp("^"+X+"$"),T={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:RegExp("^"+Z),PSEUDO:RegExp("^"+U),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)",
"i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},ra=/^(?:input|select|textarea|button)$/i,sa=/^h\d$/i,xa=/^[^{]+\{\s*\[native \w/,ta=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ba=/[+~]/,va=/'|\\/g,ga=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)",
"ig"),ha=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,1023&a|56320)};try{da.apply(fa=V.call(K.childNodes),K.childNodes),fa[K.childNodes.length].nodeType}catch(ya){da={apply:fa.length?function(a,b){aa.apply(a,V.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}w=b.support={};ka=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};ca=b.setDocument=function(a){var b,
c=a?a.ownerDocument||a:K;a=c.defaultView;return c!==C&&9===c.nodeType&&c.documentElement?(C=c,R=c.documentElement,F=!ka(c),a&&a!==a.top&&(a.addEventListener?a.addEventListener("unload",function(){ca()},!1):a.attachEvent&&a.attachEvent("onunload",function(){ca()})),w.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),w.getElementsByTagName=f(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),w.getElementsByClassName=xa.test(c.getElementsByClassName)&&
f(function(a){return a.innerHTML="<div class='a'></div><div class='a i'></div>",a.firstChild.className="i",2===a.getElementsByClassName("i").length}),w.getById=f(function(a){return R.appendChild(a).id=y,!c.getElementsByName||!c.getElementsByName(y).length}),w.getById?(q.find.ID=function(a,b){if(typeof b.getElementById!==H&&F){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},q.filter.ID=function(a){var b=a.replace(ga,ha);return function(a){return a.getAttribute("id")===b}}):(delete q.find.ID,
...
a.parentNode.selectedIndex,!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!q.pseudos.empty(a)},header:function(a){return sa.test(a.nodeName)},input:function(a){return ra.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===a.type&&(null==(b=a.getAttribute("type"))||"text"===
...
reset:!0})q.pseudos[L]=l(L);m.prototype=q.filters=q.pseudos;q.setFilters=new m;wa=b.tokenize=function(a,c){var d,e,f,g,h,k,l;if(h=N[a+" "])return c?0:h.slice(0);h=a;k=[];for(l=q.preFilter;h;){d&&!(e=ma.exec(h))||(e&&(h=h.slice(e[0].length)||h),k.push(f=[]));d=!1;(e=na.exec(h))&&(d=e.shift(),f.push({value:d,type:e[0].replace(P," ")}),h=h.slice(d.length));for(g in q.filter)!(e=T[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),h=h.slice(d.length));if(!d)break}return c?
...
g=1===f?a:d.Deferred(),h=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?Q.call(arguments):d;c===k?g.notifyWith(b,c):--f||g.resolveWith(b,c)}},k,l,p;if(1<e)for(k=Array(e),l=Array(e),p=Array(e);e>b;b++)c[b]&&d.isFunction(c[b].promise)?c[b].promise().done(h(b,p,c)).fail(g.reject).progress(h(b,l,k)):--f;return f||g.resolveWith(p,c),g.promise()}});var ya;d.fn.ready=function(a){return d.ready.promise().done(a),this};d.extend({isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:
d.ready(!0)},ready:function(a){(!0===a?--d.readyWait:d.isReady)||(d.isReady=!0,!0!==a&&0<--d.readyWait||(ya.resolveWith(r,[d]),d.fn.triggerHandler&&(d(r).triggerHandler("ready"),d(r).off("ready"))))}});d.ready.promise=function(a){return ya||(ya=d.Deferred(),"complete"===r.readyState?setTimeout(d.ready):(r.addEventListener("DOMContentLoaded",pa,!1),v.addEventListener("load",pa,!1))),ya.promise(a)};d.ready.promise();var N=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,p=null==c;if("object"===d.type(c))for(k in f=
...
c?c:b)},remove:function(a,b){var c,e,f=this.key(a),g=this.cache[f];if(void 0===b)this.cache[f]={};else for(d.isArray(b)?e=b.concat(b.map(d.camelCase)):(c=d.camelCase(b),b in g?e=[b,c]:(e=c,e=e in g?[e]:e.match(G)||[])),c=e.length;c--;)delete g[e[c]]},hasData:function(a){return!d.isEmptyObject(this.cache[a[this.expando]]||{})},discard:function(a){a[this.expando]&&delete this.cache[a[this.expando]]}};var t=new M,A=new M,Mb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Lb=/([A-Z])/g;d.extend({hasData:function(a){return A.hasData(a)||
...
"fx";h--;)(c=t.get(g[h],a+"queueHooks"))&&c.empty&&(e++,c.empty.add(k));return k(),f.promise(b)}});var za=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,H=["Top","Right","Bottom","Left"],U=function(a,b){return a=b||a,"none"===d.css(a,"display")||!d.contains(a.ownerDocument,a)},sb=/^(?:checkbox|radio)$/i;!function(){var a=r.createDocumentFragment().appendChild(r.createElement("div")),b=r.createElement("input");b.setAttribute("type","radio");b.setAttribute("checked","checked");b.setAttribute("name","t");
...
a.returnValue?qa:Y):this.type=a,b&&d.extend(this,b),this.timeStamp=a&&a.timeStamp||d.now(),void(this[d.expando]=!0)):new d.Event(a,b)};d.Event.prototype={isDefaultPrevented:Y,isPropagationStopped:Y,isImmediatePropagationStopped:Y,preventDefault:function(){var a=this.originalEvent;this.isDefaultPrevented=qa;a&&a.preventDefault&&a.preventDefault()},stopPropagation:function(){var a=this.originalEvent;this.isPropagationStopped=qa;a&&a.stopPropagation&&a.stopPropagation()},stopImmediatePropagation:function(){var a=
...
prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var e=[],f=d(a),g=f.length-1,h=0;g>=h;h++)a=h===g?this:this.clone(!0),d(f[h])[b](a),Ka.apply(e,a.get());return this.pushStack(e)}});var T,$a={},ab=/^margin/,Ga=RegExp("^("+za+")(?!px)[a-z%]+$","i"),ra=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)};!function(){var a,b,c=r.documentElement,e=r.createElement("div"),f=r.createElement("div");if(f.style){f.style.backgroundClip=
...
null).marginRight),c.removeChild(e),a}})}}();d.swap=function(a,b,c,d){var f,g={};for(f in b)g[f]=a.style[f],a.style[f]=b[f];c=c.apply(a,d||[]);for(f in b)a.style[f]=g[f];return c};var gc=/^(none|table(?!-c[ea]).+)/,Qb=RegExp("^("+za+")(.*)$","i"),hc=RegExp("^([+-])=("+za+")","i"),ic={position:"absolute",visibility:"hidden",display:"block"},yb={letterSpacing:"0",fontWeight:"400"},db=["Webkit","O","Moz","ms"];d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Z(a,"opacity");return""===c?"1":
...
n.done(function(){var b;t.remove(a,"fxshow");for(b in m)d.style(a,b,m[b])}),m)b=jb(u?r[e]:0,e,n),e in r||(r[e]=b.start,u&&(b.end=b.start,b.start="width"===e||"height"===e?1:0))}],P={"*":[function(a,b){var c=this.createTween(a,b),e=c.cur(),f=zb.exec(b),g=f&&f[3]||(d.cssNumber[a]?"":"px"),h=(d.cssNumber[a]||"px"!==g&&+e)&&zb.exec(d.css(c.elem,a)),k=1,l=20;if(h&&h[3]!==g){g=g||h[3];f=f||[];h=+e||1;do k=k||".5",h/=k,d.style(c.elem,a,h+g);while(k!==(k=c.cur()/e)&&1!==k&&--l)}return f&&(h=c.start=+h||+e||
0,c.unit=g,c.end=f[1]?h+(f[1]+1)*f[2]:+f[2]),c}]};d.Animation=d.extend(kb,{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,e=0,f=a.length;f>e;e++)c=a[e],P[c]=P[c]||[],P[c].unshift(b)},prefilter:function(a,b){b?ta.unshift(a):ta.push(a)}});d.speed=function(a,b,c){var e=a&&"object"==typeof a?d.extend({},a):{complete:c||!c&&b||d.isFunction(a)&&a,duration:a,easing:c&&b||b&&!d.isFunction(b)&&b};return e.duration=d.fx.off?0:"number"==typeof e.duration?e.duration:e.duration in
...
b=c.parseFromString(a,"text/xml")}catch(e){b=void 0}return(!b||b.getElementsByTagName("parsererror").length)&&d.error("Invalid XML: "+a),b};var S,O,nc=/#.*$/,Bb=/([?&])_=[^&]*/,oc=/^(.*?):[ \t]*([^\r\n]*)$/gm,pc=/^(?:GET|HEAD)$/,qc=/^\/\//,Cb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Db={},Ha={},Eb="*/".concat("*");try{O=location.href}catch(yc){O=r.createElement("a"),O.href="",O=O.href}S=Cb.exec(O.toLowerCase())||[];d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:O,
type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(S[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Eb,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},
...
abort:function(a){a=a||w;return e&&e.abort(a),c(0,a),this}};if(t.promise(q).complete=v.add,q.success=q.done,q.error=q.fail,m.url=((a||m.url||O)+"").replace(nc,"").replace(qc,S[1]+"//"),m.type=b.method||b.type||m.method||m.type,m.dataTypes=d.trim(m.dataType||"*").toLowerCase().match(G)||[""],null==m.crossDomain&&(l=Cb.exec(m.url.toLowerCase()),m.crossDomain=!(!l||l[1]===S[1]&&l[2]===S[2]&&(l[3]||("http:"===l[1]?"80":"443"))===(S[3]||("http:"===S[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&
...
var uc=0,Ba={},vc={0:200,1223:204},na=d.ajaxSettings.xhr();v.ActiveXObject&&d(v).on("unload",function(){for(var a in Ba)Ba[a]()});x.cors=!!na&&"withCredentials"in na;x.ajax=na=!!na;d.ajaxTransport(function(a){var b;return x.cors||na&&!a.crossDomain?{send:function(c,d){var f,g=a.xhr(),h=++uc;if(g.open(a.type,a.url,a.async,a.username,a.password),a.xhrFields)for(f in a.xhrFields)g[f]=a.xhrFields[f];a.mimeType&&g.overrideMimeType&&g.overrideMimeType(a.mimeType);a.crossDomain||c["X-Requested-With"]||(c["X-Requested-With"]=
"XMLHttpRequest");for(f in c)g.setRequestHeader(f,c[f]);b=function(a){return function(){b&&(delete Ba[h],b=g.onload=g.onerror=null,"abort"===a?g.abort():"error"===a?d(g.status,g.statusText):d(vc[g.status]||g.status,g.statusText,"string"==typeof g.responseText?{text:g.responseText}:void 0,g.getAllResponseHeaders()))}};g.onload=b();g.onerror=b("error");b=Ba[h]=b("abort");try{g.send(a.hasContent&&a.data||null)}catch(k){if(b)throw k;}},abort:function(){b&&b()}}:void 0});d.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
