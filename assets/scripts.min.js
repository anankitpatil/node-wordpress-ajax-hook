...
!g["*"]&&f("*")}function Ia(a,b){var c,e,f=d.ajaxSettings.flatOptions||{};for(c in b)void 0!==b[c]&&((f[c]?a:e||(e={}))[c]=b[c]);return e&&d.extend(!0,a,e),a}function Ja(a,b,c,e){var f;if(d.isArray(b))d.each(b,function(b,d){c||Sb.test(a)?e(a,d):Ja(a+"["+("object"==typeof d?b:"")+"]",d,c,e)});else if(c||"object"!==d.type(b))e(a,b);else for(f in b)Ja(a+"["+f+"]",b[f],c,e)}var ba=[],Q=ba.slice,nb=ba.concat,Ka=ba.push,oa=ba.indexOf,ca={},Tb=ca.toString,La=ca.hasOwnProperty,x={},r=w.document,d=function(a,
b){return new d.fn.init(a,b)},Ub=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,Vb=/^-ms-/,Wb=/-([\da-z])/gi,Xb=function(a,b){return b.toUpperCase()};d.fn=d.prototype={jquery:"2.1.1",constructor:d,selector:"",length:0,toArray:function(){return Q.call(this)},get:function(a){return null!=a?0>a?this[a+this.length]:this[a]:Q.call(this)},pushStack:function(a){a=d.merge(this.constructor(),a);return a.prevObject=this,a.context=this.context,a},each:function(a,b){return d.each(this,a,b)},map:function(a){return this.pushStack(d.map(this,
function(b,c){return a.call(b,c,b)}))},slice:function(){return this.pushStack(Q.apply(this,arguments))},first:function(){return this.eq(0)},last:function(){return this.eq(-1)},eq:function(a){var b=this.length;a=+a+(0>a?b:0);return this.pushStack(0<=a&&b>a?[this[a]]:[])},end:function(){return this.prevObject||this.constructor(null)},push:Ka,sort:ba.sort,splice:ba.splice};d.extend=d.fn.extend=function(){var a,b,c,e,f,g,h=arguments[0]||{},k=1,l=arguments.length,p=!1;"boolean"==typeof h&&(p=h,h=arguments[k]||
...
b.getElementsByClassName(g)),c}if(v.qsa&&(!D||!D.test(a))){if(f=e=y,g=b,k=9===h&&a,1===h&&"object"!==b.nodeName.toLowerCase()){h=wa(a);(e=b.getAttribute("id"))?f=e.replace(va,"\\$&"):b.setAttribute("id",f);f="[id='"+f+"'] ";for(g=h.length;g--;)h[g]=f+s(h[g]);g=ca.test(a)&&n(b.parentNode)||b;k=h.join(",")}if(k)try{return ea.apply(c,g.querySelectorAll(k)),c}catch(l){}finally{e||b.removeAttribute("id")}}}return z(a.replace(P,"$1"),b,c,d)}function c(){function a(c,d){return b.push(c+" ")>q.cacheLength&&
...
c(f,d,e))&&(g.push(f),l&&b.push(h));return g}function r(a,c,f,g,h,k){return g&&!g[y]&&(g=r(g)),h&&!h[y]&&(h=r(h,k)),d(function(d,e,k,l){var m,n,p=[],Na=[],s=e.length,q;if(!(q=d)){q=c||"*";for(var u=k.nodeType?[k]:k,t=[],r=0,ka=u.length;ka>r;r++)b(q,u[r],t);q=t}q=!a||!d&&c?q:w(q,p,a,k,l);u=f?h||(d?a:s||g)?[]:e:q;if(f&&f(q,u,k,l),g)for(m=w(u,Na),g(m,[],k,l),k=m.length;k--;)(n=m[k])&&(u[Na[k]]=!(q[Na[k]]=n));if(d){if(h||a){if(h){m=[];for(k=u.length;k--;)(n=u[k])&&m.push(q[k]=n);h(null,u=[],m,l)}for(k=
u.length;k--;)(n=u[k])&&-1<(m=h?ja.call(d,n):p[k])&&(d[m]=!(e[m]=n))}}else u=w(u===e?u.splice(s,u.length):u),h?h(null,e,u,l):ea.apply(e,u)})}function x(a){var b,c,d,e=a.length,f=q.relative[a[0].type];c=f||q.relative[" "];for(var g=f?1:0,h=u(function(a){return a===b},c,!0),k=u(function(a){return-1<ja.call(b,a)},c,!0),l=[function(a,c,d){return!f&&(d||c!==J)||((b=c).nodeType?h(a,c,d):k(a,c,d))}];e>g;g++)if(c=q.relative[a[g].type])l=[u(t(l),c)];else{if(c=q.filter[a[g].type].apply(null,a[g].matches),c[y]){for(d=
++g;e>d&&!q.relative[a[d].type];d++);return r(1<g&&t(l),1<g&&s(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(P,"$1"),c,d>g&&x(a.slice(g,d)),e>d&&x(a=a.slice(d)),e>d&&s(a))}l.push(c)}return t(l)}function A(a,c){var f=0<c.length,g=0<a.length,h=function(d,e,h,k,l){var m,n,p,s=0,V="0",u=d&&[],t=[],r=J,ka=d||g&&q.find.TAG("*",l),y=E+=null==r?1:Math.random()||0.1,x=ka.length;for(l&&(J=e!==C&&e);V!==x&&null!=(m=ka[V]);V++){if(g&&m){for(n=0;p=a[n++];)if(p(m,e,h)){k.push(m);break}l&&(E=
y)}f&&((m=!p&&m)&&s--,d&&u.push(m))}if(s+=V,f&&V!==s){for(n=0;p=c[n++];)p(u,t,e,h);if(d){if(0<s)for(;V--;)u[V]||t[V]||(t[V]=aa.call(k));t=w(t)}ea.apply(k,t);l&&!d&&0<t.length&&1<s+c.length&&b.uniqueSort(k)}return l&&(E=y,J=r),u};return f?d(h):h}var L,v,q,B,ka,wa,Oa,z,J,fa,ua,da,C,R,F,D,la,I,G,y="sizzle"+-new Date,K=a.document,E=0,Q=0,pb=c(),N=c(),O=c(),M=function(a,b){return a===b&&(ua=!0),0},H="undefined",S=-2147483648,Y={}.hasOwnProperty,ga=[],aa=ga.pop,ba=ga.push,ea=ga.push,W=ga.slice,ja=ga.indexOf||
...
"i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},ra=/^(?:input|select|textarea|button)$/i,sa=/^h\d$/i,xa=/^[^{]+\{\s*\[native \w/,ta=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ca=/[+~]/,va=/'|\\/g,ha=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)",
"ig"),ia=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,1023&a|56320)};try{ea.apply(ga=W.call(K.childNodes),K.childNodes),ga[K.childNodes.length].nodeType}catch(ya){ea={apply:ga.length?function(a,b){ba.apply(a,W.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}v=b.support={};ka=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};da=b.setDocument=function(a){var b,
c=a?a.ownerDocument||a:K;a=c.defaultView;return c!==C&&9===c.nodeType&&c.documentElement?(C=c,R=c.documentElement,F=!ka(c),a&&a!==a.top&&(a.addEventListener?a.addEventListener("unload",function(){da()},!1):a.attachEvent&&a.attachEvent("onunload",function(){da()})),v.attributes=f(function(a){return a.className="i",!a.getAttribute("className")}),v.getElementsByTagName=f(function(a){return a.appendChild(c.createComment("")),!a.getElementsByTagName("*").length}),v.getElementsByClassName=xa.test(c.getElementsByClassName)&&
...
void 0},la=[],D=[],(v.qsa=xa.test(c.querySelectorAll))&&(f(function(a){a.innerHTML="<select msallowclip=''><option selected=''></option></select>";a.querySelectorAll("[msallowclip^='']").length&&D.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||D.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll(":checked").length||D.push(":checked")}),
f(function(a){var b=c.createElement("input");b.setAttribute("type","hidden");a.appendChild(b).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&D.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||D.push(":enabled",":disabled");a.querySelectorAll("*,:x");D.push(",.*:")})),(v.matchesSelector=xa.test(I=R.matches||R.webkitMatchesSelector||R.mozMatchesSelector||R.oMatchesSelector||R.msMatchesSelector))&&f(function(a){v.disconnectedMatch=I.call(a,"div");I.call(a,
...
c=f(a,null,d,[]);for(d=a.length;d--;)(e=c[d])&&(a[d]=!(b[d]=e))}):function(a,d,e){return b[0]=a,f(b,null,e,c),!c.pop()}}),has:d(function(a){return function(c){return 0<b(a,c).length}}),contains:d(function(a){return function(b){return-1<(b.textContent||b.innerText||B(b)).indexOf(a)}}),lang:d(function(a){return qa.test(a||"")||b.error("unsupported lang: "+a),a=a.replace(ha,ia).toLowerCase(),function(b){var c;do if(c=F?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=c.toLowerCase(),
...
function(a,b,c){var d;return c?void 0:!0===a[b]?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null}),b}(w);d.find=W;d.expr=W.selectors;d.expr[":"]=d.expr.pseudos;d.unique=W.uniqueSort;d.text=W.getText;d.isXMLDoc=W.isXML;d.contains=W.contains;var qb=d.expr.match.needsContext,rb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Jb=/^.[^:#\[\.,]*$/;d.filter=function(a,b,c){var e=b[0];return c&&(a=":not("+a+")"),1===b.length&&1===e.nodeType?d.find.matchesSelector(e,a)?[e]:[]:d.find.matches(a,d.grep(b,function(a){return 1===
...
d.ready(!0)},ready:function(a){(!0===a?--d.readyWait:d.isReady)||(d.isReady=!0,!0!==a&&0<--d.readyWait||(ya.resolveWith(r,[d]),d.fn.triggerHandler&&(d(r).triggerHandler("ready"),d(r).off("ready"))))}});d.ready.promise=function(a){return ya||(ya=d.Deferred(),"complete"===r.readyState?setTimeout(d.ready):(r.addEventListener("DOMContentLoaded",pa,!1),w.addEventListener("load",pa,!1))),ya.promise(a)};d.ready.promise();var N=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,p=null==c;if("object"===d.type(c))for(k in f=
...
b?[a]:d.makeArray(b,[a]),n=d.event.special[s]||{},e||!n.trigger||!1!==n.trigger.apply(c,b))){if(!e&&!n.noBubble&&!d.isWindow(c)){k=n.delegateType||s;for(tb.test(k+s)||(g=g.parentNode);g;g=g.parentNode)m.push(g),h=g;h===(c.ownerDocument||r)&&m.push(h.defaultView||h.parentWindow||w)}for(f=0;(g=m[f++])&&!a.isPropagationStopped();)a.type=1<f?k:n.bindType||s,(p=(t.get(g,"events")||{})[a.type]&&t.get(g,"handle"))&&p.apply(g,b),(p=l&&g[l])&&p.apply&&d.acceptData(g)&&(a.result=p.apply(g,b),!1===a.result&&
...
abort:function(a){a=a||v;return e&&e.abort(a),c(0,a),this}};if(t.promise(q).complete=w.add,q.success=q.done,q.error=q.fail,m.url=((a||m.url||O)+"").replace(nc,"").replace(qc,S[1]+"//"),m.type=b.method||b.type||m.method||m.type,m.dataTypes=d.trim(m.dataType||"*").toLowerCase().match(G)||[""],null==m.crossDomain&&(l=Cb.exec(m.url.toLowerCase()),m.crossDomain=!(!l||l[1]===S[1]&&l[2]===S[2]&&(l[3]||("http:"===l[1]?"80":"443"))===(S[3]||("http:"===S[1]?"80":"443")))),m.data&&m.processData&&"string"!=typeof m.data&&
...
(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&q.setRequestHeader("Content-Type",m.contentType);q.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Eb+"; q=0.01":""):m.accepts["*"]);for(n in m.headers)q.setRequestHeader(n,m.headers[n]);if(m.beforeSend&&(!1===m.beforeSend.call(s,q,m)||2===L))return q.abort();v="abort";for(n in{success:1,error:1,complete:1})q[n](m[n]);if(e=mb(Ha,m,b,q)){q.readyState=1;p&&r.trigger("ajaxSend",
...
e):!1!==a.jsonp&&(a.url+=(Ra.test(a.url)?"&":"?")+a.jsonp+"="+e),a.converters["script json"]=function(){return g||d.error(e+" was not called"),g[0]},a.dataTypes[0]="json",f=w[e],w[e]=function(){g=arguments},c.always(function(){w[e]=f;a[e]&&(a.jsonpCallback=b.jsonpCallback,Gb.push(e));g&&d.isFunction(f)&&f(g[0]);g=f=void 0}),"script"):void 0});d.parseHTML=function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1);b=b||r;var e=rb.exec(a);c=!c&&[];return e?[b.createElement(e[1])]:
...
a])):void 0===e?d.css(b,c,k):d.style(b,c,e,k)},b,h?e:void 0,h,null)}})});d.fn.size=function(){return this.length};d.fn.andSelf=d.fn.addBack;"function"==typeof define&&define.amd&&define("jquery",[],function(){return d});var wc=w.jQuery,xc=w.$;return d.noConflict=function(a){return w.$===d&&(w.$=xc),a&&w.jQuery===d&&(w.jQuery=wc),d},"undefined"===typeof X&&(w.jQuery=w.$=d),d});window.onload=function(){$(window).width();$(window).height();1==$("link[href='/assets/styles.min.css']").length&&alert("JQuery Loaded");$(window).scroll(function(){$(window).scrollTop()});$(window).resize(function(){$(window).width();$(window).height()})};var AP={init:function(){},anim:function(){},getcontent:function(){$.get("/allposts",function(w){})}};
